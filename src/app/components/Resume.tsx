            ...
            return (
                <div className="grid md:grid-cols-2 gap-8">
                    {resumeData.experience.map((experience, index) => (
                        ...
                        className="relative pl-8 before:absolute before:left-0
                        before:top-2 before:w-2 before:h-2 before:bg-emerald-400
                        before:rounded-full"
              ...
              <div className="bg-gray-900 p-6 rounded-xl">
                  ...
                  <div className="flex flex-wrap gap-2">
                      {resumeData.about.interests.map((interest, index) => (
                        <span
                          key={index}
                          className="px-3 py-1 bg-gray-800 text-emerald-400
